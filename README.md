...
*   `video_thumbnail_url` (Optional, String): URL to a thumbnail image for the product video. If provided, this will be used for the product's main thumbnail. If not provided, the product's main image (from the `images` column) will be used as the thumbnail.
