...
def check_table_exists(table_name, schema_name=PUBLIC_SCHEMA):
    bind = op.get_bind()  # Get the DB connection
...
def upgrade() -> None:
    ...
    if not check_table_exists('brands', CATALOG_SCHEMA):
        ...
        print("Table 'attribute' already exists, skipping creation.")
        
    if not check_table_exists('attribute', CATALOG_SCHEMA):
    ...
    if not check_table_exists('attribute_value', CATALOG_SCHEMA):
        ...
        print("Table 'attribute_value' already exists, skipping creation.")
        
    if not check_table_exists('business_details', PUBLIC_SCHEMA):
        ...
        print("Table 'business_details' already exists, skipping creation.")
        
    if not check_table_exists('return_policy', PUBLIC_SCHEMA):
    # New return_policy table in PUBLIC_SCHEMA
        ...
        print("Table 'return_policy' already exists, skipping creation.")


    if not check_table_exists('upload_sessions', PUBLIC_SCHEMA):
        ...
        print("Table 'upload_sessions' already exists, skipping creation.")


    if not check_table_exists('categories', PUBLIC_SCHEMA):
        ...
        print("Table 'categories' already exists, skipping creation.")
    
    if not check_table_exists('products', PUBLIC_SCHEMA):
