...
# ProductCsvModel is now defined in app.dataload.models.product_csv
# Ensure validators and other components import it from there.
...
class ErrorType(str, Enum):
    ...
    BATCH_PROCESSING_ERROR = "BATCH_PROCESSING_ERROR" # Added new error type
    UNKNOWN = "UNKNOWN"
