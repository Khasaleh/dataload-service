...
# Example settings class to load environment variables
class Settings(BaseSettings):
    ENVIRONMENT: str = "production"  # Can be "development", "staging", etc.
...
# Log the environment, without any reference to 'reload'
logger.info(f"FastAPI application startup... Environment: {settings.ENVIRONMENT}")

# SKU Processing Pipeline
